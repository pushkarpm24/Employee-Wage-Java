...
public class employeWage implements WageMethod	{
	//CONSTANTS
	...
	public static void main(String args[]) {
		...
		wage.computeTotalEmpWage(company[0]);

		company[1] = new CompanyEmpWage( "CAPGEMENI", 30, 20, 70 );
		wage.computeTotalEmpWage(company[1]);
	}
}
